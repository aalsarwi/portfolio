  ...
  const projects = [
    {
      ...
      category: 'CAD/Design',
      description:
        '•	Designed and built a portable case in SolidWorks for a PCP system by integrating safe electrical routing with the customized 24 micro pin cutout, attaching it securely to the chassis for reliability and ease of access', 
      image:
        '/uploads/PCBcase.png',
      images: [
        '/uploads/Case.png',
      ...
      budget: '$0',
      achievements: [
        'Allowed for easier access to the PCB.',
        'Improved spcae allocation of the chassis.',
        'Finished the AutoCAD design updates one week ahead of schedule.',
        'Adopted in 2 vehicle models for prototyping',
      ],
      role: 'Junior Chassis Coordinator',
      objectives: [
        'Create a portable and durable case in SolidWorks that securely houses the PCP system and allows easy access for testing and maintenance.',
        'Integrate safe and organized electrical routing with a precise 24-micro-pin cutout to ensure reliable connections and protected wiring.',
      ],
      challenges: [
        'Ensuring the electrical routing fit safely within the limited space while preventing wire strain or interference with other components.',
        'Designing an accurate 24-micro-pin cutout that aligned perfectly with the existing connector geometry and mounted securely onto the chassis.',
      ],
      solutions: [
        'Modeled internal pathways in SolidWorks to route wiring safely, tested clearances, and added support features to prevent movement or damage.',
        'Used precise measurements and iterative SolidWorks sketches to create a cutout that matched the micro-pin connector, then reinforced the mounting area to keep the case firmly attached to the chassis.',
      ],
      links: { demo: '#', github: '#' },
    },
    {
